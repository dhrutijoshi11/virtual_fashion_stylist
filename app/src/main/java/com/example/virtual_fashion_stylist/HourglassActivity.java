    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(HourglassActivity.this, TopActivity.class));
            }
        });
        ...
        btnBottom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(HourglassActivity.this, BottomActivity.class));
            }
        });
        ...
        btnDress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(HourglassActivity.this, DressActivity.class));
            }
        });
    }
}