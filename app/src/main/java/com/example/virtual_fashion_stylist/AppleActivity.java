    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AppleActivity.this, TopActivity.class));
            }
        });
        ...
        btnBottom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AppleActivity.this, BottomActivity.class));
            }
        });
        ...
        btnDress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AppleActivity.this, DressActivity.class));
            }
        });
    }
}